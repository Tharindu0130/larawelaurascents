...
<div class="bg-white">
    ...
    <div class="relative bg-gray-900 text-white">
        <div class="absolute inset-0">
            <img class="w-full h-full object-cover opacity-30" src="https://images.unsplash.com/photo-1615634260167-c8cdede054de?ixlib=rb-4.0.3&auto=format&fit=crop&w=1920&q=80" alt="Perfume background">
        </div>
        ...
        <div class="lg:grid lg:grid-cols-2 lg:gap-8 lg:items-center">
            <div>
                ...
                <div class="mt-8 sm:flex">
                    <div class="rounded-md shadow">
                        <a href="{{ route('products') }}" class="flex items-center justify-center px-5 py-3 border border-transparent text-base font-medium rounded-md text-white bg-indigo-600 hover:bg-indigo-700">
                            Shop Collection
                        </a>
                    </div>
                </div>
            ...
            <div class="mt-8 lg:mt-0">
                <div class="relative mx-auto w-full rounded-lg shadow-lg lg:max-w-md">
                   <img class="w-full rounded-lg" src="https://images.unsplash.com/photo-1595425279313-255d4c825a07?ixlib=rb-4.0.3&auto=format&fit=crop&w=800&q=80" alt="Perfume bottle">
                </div>
            </div>
        </div>
    </div>
